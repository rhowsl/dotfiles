...
theme.wallpaper                                 = os.getenv("HOME") .. "/Downloads/hqdefault.jpg"
...
-- the clock itself
local mytextclock = wibox.widget.textclock("%r", 1, "America/Sao_Paulo")
...
theme.mpd = lain.widget.mpd({
    settings = function()
        if mpd_now.state == "play" then
            ...
            widget:set_markup(markup.font(theme.font, markup("#000000", artist) .. " " .. title))
...
local function rawpl(widget, bgcolor)
    return wibox.container.background(widget, bgcolor, theme.powerline_rl)
end
...
function theme.at_screen_connect(s)
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            ...
            pl(wibox.widget { mpdicon, theme.mpd.widget, layout = wibox.layout.align.horizontal }, "#FF0018"),
            -- pl(task, "#343434"),
            -- pl(wibox.widget { mailicon, mail and theme.mail.widget, layout = wibox.layout.align.horizontal }, "#343434"),
            pl(wibox.widget { memicon, mem.widget, layout = wibox.layout.align.horizontal }, "#FFA52C"),
            pl(wibox.widget { cpuicon, cpu.widget, layout = wibox.layout.align.horizontal }, "#FFFF41"),
            -- pl(wibox.widget { tempicon, temp.widget, layout = wibox.layout.align.horizontal }, "#4B3B51"),
            -- pl(wibox.widget { fsicon, theme.fs and theme.fs.widget, layout = wibox.layout.align.horizontal }, "#CB755B"),
            pl(wibox.widget { baticon, bat.widget, layout = wibox.layout.align.horizontal }, "#008018"),
            pl(wibox.widget { neticon, net.widget, layout = wibox.layout.align.horizontal }, "#0000F9"),
            wibox.container.background(wibox.container.margin(mytextclock, dpi(16), dpi(16)), "#86007D", theme.powerline_rl),
            s.mylayoutbox,            
        },
    }
end
